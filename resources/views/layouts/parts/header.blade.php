                    ...
                    <ul class="topbar-items">
                        @if(!Auth::id())
                            ...
                            <li class="signup-item">
                                <a href="#register" data-toggle="modal" data-target="#register" class="signup">{{__('Đăng ký')}}</a>
                            </li>
                        @else
                            <li class="login-item dropdown">
                                ...
                                <a href="#" data-toggle="dropdown" class="is_login">
                                    ...
                                    @endif
                                    {{__("Chào, :Name",['name'=>Auth::user()->name])}}
                                    <i class="fa fa-angle-down"></i>
                                </a>
                                <ul class="dropdown-menu text-left">
                                    <li><a href="{{url('/user/profile')}}"><i class="icon ion-md-construct"></i> {{__("Thông tin của tôi")}}</a></li>

                                    @if(Auth::user()->hasPermissionTo('dashboard_access'))
                                        <li class="menu-hr"><a href="{{url('/admin')}}"><i class="icon ion-ios-ribbon"></i> {{__("Bảng điều khiển")}}</a></li>
                                    @endif
                                    <li class="menu-hr">
                                        <a  href="#" onclick="event.preventDefault(); document.getElementById('logout-form').submit();"><i class="fa fa-sign-out"></i> {{__('Đăng xuất')}}</a>
                                    </li>
                                </ul>
