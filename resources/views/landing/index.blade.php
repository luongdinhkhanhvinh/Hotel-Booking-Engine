...
<head>
    <meta charset="UTF-8"/>
    <title>App đặt phòng -Hệ thống đặt phòng tiện lợi</title>
                ...
                <div class="col-xs-9">
                    <div class="dropdown dropdown-main-menu">
                        ...
                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                            <a class="dropdown-item" href="https://www.facebook.com/bookingcore/" target="_blank">Hổ trợ</a>
                            <a class="dropdown-item" href="http://docs.bookingcore.org">Tài liệu</a>
                            <a href="{{config('landing.item_url')}}"
                               class="dropdown-item btn-buynow">MUA NGAY</a></li>
                        </div>
                    </div>
                    <ul class="menu">
                        <li>
                            <a href="{{config('landing.item_url')}}"
                               class="btn-buynow">MUA NGAY</a></li>
                        <li><a href="https://www.facebook.com/bookingcore/">Hổ trợ</a></li>
                        <li><a href="http://docs.bookingcore.org">Tài liệu</a></li>
                    </ul>
                </div>
            </div>
        </div>
    ...
    <div class="container">
        <div class="row ld-full-height">
            <div class="col-lg-6">
                <h2 class="heading">
                    <span>Hệ thống</span>
                    Đặt Phòng Tiện Lợi<br/>
                    trên nền Laravel
                </h2>
                {{--<p class="desc">Được tin tưởng bởi <span>6000+</span> Khách hàng hài lòng</p>--}}
                {{--<p class="desc">Đã hoàn thành Hệ thống đặt phòng OTA cho khách sạn, phòng, tour, xe hơi, cho thuê, thích hoạt động--}}
...
<div class="full-demo">
    <div class="text-heading">
        <h3>Bản demo trang web đầy đủ</h3>
        <p>Trình demo nhập liệu dễ dàng,<br />tất cả các tính năng trong tất cả các bản demo có thể được kết hợp.</p>
...
<!--<img src="<?php /*echo $url . '/img/footer-corrner.png'; */?>" class="footer-corrner"/>-->
    <div class="container">
        <h3>Tạo đặt chổ riêng bạn<br />Hệ thống với <span>App đặt phòng</span> là siêu<br />nhanh và đơn giản <img src="{{url('landing/img/hand.svg')}}" /></h3>
        <a href="{{config('landing.item_url')}}"
           class="btn-buynow">MUA NGAY</a>
        <div class="social">
            <span>THEO DÕI TẠI</span>
            <ul>
                <li><a href="#"><svg width="10" height="19" viewBox="0 0 10 19" fill="none" xmlns="http://www.w3.org/2000/svg">
