    ...
    <div class="bravo_detail_tour">
        ...
        <div class="bravo-more-book-mobile">
            <div class="container">
                <div class="left">
                    ...
                    <div class="service-review tour-review-<?php echo e($score_total); ?>">
                        ...
                        <?php if($reviewData['total_review'] > 1): ?>
                                <?php echo e(__(":number Đánh giá",["number"=>$reviewData['total_review'] ])); ?>
                ...
                <div class="right">
                    <a class="btn btn-primary bravo-button-book-mobile"><?php echo e(__("Đặt Ngay")); ?></a>
                </div>
            </div>
        </div>
    </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\Booking Core 1.1.0\booking-core\modules/Tour/Views/frontend/detail.blade.php ENDPATH**/ ?>