<?php $__env->startSection('content'); ?>
    <div class="container-fluid">
        <div class="d-flex justify-content-between mb20">
            <h1 class="title-bar"><?php echo e(__("Ngôn ngữ")); ?></h1>
        </div>
        <?php echo $__env->make('admin.message', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        <div class="row">
            <div class="col-md-4 mb40">
                <div class="panel">
                    <div class="panel-title"><?php echo e(__("Tất cả ngôn ngữ")); ?></div>
                    <div class="panel-body">
                        <form action="" class="needs-validation" novalidate method="post">
                            ...
                            <div class="">
                                <button class="btn btn-primary" type="submit"><?php echo e(__("Thêm mới")); ?></button>
                            </div>
                        </form>
                    </div>
                </div>
                ...
                <div class="filter-div d-flex justify-content-between ">
                        ...
                        <?php if(!empty($rows)): ?>
                            <form method="post" action="<?php echo e(url('admin/module/language/editBulk')); ?>" class="filter-form filter-form-left d-flex justify-content-start">
                                ...
                                <select name="action" class="form-control">
                                    ...
                                    <option value="publish"><?php echo e(__(" Công bố ")); ?></option>
                                    <option value="draft"><?php echo e(__(" Chuyển vào thư mục nháp ")); ?></option>
                    ...
                    <div class="col-left">
                        <form method="get" action="<?php echo e(url('/admin/module/language')); ?>" class="filter-form filter-form-right d-flex justify-content-end" role="search">
                            <input type="text" name="s" value="<?php echo e(Request()->s); ?>" class="form-control" placeholder="<?php echo e(__("Tìm kiếm theo tên")); ?>">
                            <button class="btn-info btn btn-icon btn_search" id="search-submit" type="submit"><?php echo e(__('Tìm kiếm')); ?></button>
                        </form>
                    </div>
                </div>
                <div class="panel">
                            ...
                            <div class="table-responsive">
                                <table class="table table-hover">
                                    ...
                                    <tr>
                                        ...
                                        <th><?php echo e(__("Địa phương")); ?></th>
                                    ...
                                    <?php else: ?>
                                        <tr>
                                            <td colspan="4"><?php echo e(__("Không có dữ liệu")); ?></td>
                                        </tr>
                                    <?php endif; ?>
                                    </tbody>
                                </table>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\Booking Core 1.1.0\booking-core\modules/Language/Views/admin/language/index.blade.php ENDPATH**/ ?>