<?php $__env->startSection('content'); ?>
    <div class="container-fluid">
        <div class="dashboard-page">
            <h4 class="welcome-title text-uppercase"><?php echo e(__('Chào mừng :name!',['name'=>Auth::user()->nameOrEmail])); ?></h4>
        </div>
        <br>
        <div class="row">
            ...
            <div class="col-md-12 col-lg-6 mb-3">
                <div class="panel">
                    <div class="panel-title d-flex justify-content-between align-items-center">
                        <strong><?php echo e(__('Thống kê thu nhập')); ?></strong>
            ...
            <div class="col-md-12 col-lg-6 ">
                <div class="panel">
                    <div class="panel-title d-flex justify-content-between">
                        <strong><?php echo e(__('Đặt phòng gần đây')); ?></strong>
                        <a href="<?php echo e(url('admin/module/report/booking')); ?>" class="btn-link"><?php echo e(__("Nhiều hơn")); ?>
                    ...
                    <div class="panel-body">
                        <div class="table-responsive">
                            <table class="table table-hover">
                                ...
                                <tr>
                                    <th width="60px">#</th>
                                    <th><?php echo e(__('Mục')); ?></th>
                                    <th width="100px"><?php echo e(__("Toàn bộ")); ?></th>
                                    <th width="100px"><?php echo e(__("Trạng thái")); ?></th>
                                    <th width="100px"><?php echo e(__("Tạo bởi")); ?></th>
                                </tr>
                                </thead>
                                <tbody>
                                ...
                                <?php else: ?>
                                    <tr>
                                        <td colspan="5"><?php echo e(__("Không có dữ liệu")); ?></td>
                                    </tr>
                                <?php endif; ?>
                                </tbody>
                            </table>
...
<?php $__env->startSection('script.body'); ?>
    ...
    <script>
            ...
            options: {
                ...
                scales: {
                    xAxes: [{
                        ...
                        scaleLabel: {
                            display: true,
                            labelString: '<?php echo e(__("Mốc thời gian")); ?>'
                        }
                    }],
                    yAxes: [{
                        display: true,
                        scaleLabel: {
                            display: true,
                            labelString: '<?php echo e(__("Đơn vị tiền tệ: :currency_main",['currency_main'=>setting_item('currency_main')])); ?>'
                        }
                    }]
                },
                tooltips: {
        ...
        $('#reportrange').daterangepicker({
            ...
            "showDropdowns": true,
            ranges: {
                '<?php echo e(__("Hôm nay")); ?>': [moment(), moment()],
                '<?php echo e(__("Hôm qua")); ?>': [moment().subtract(1, 'days'), moment().subtract(1, 'days')],
                '<?php echo e(__("7 ngày qua")); ?>': [moment().subtract(6, 'days'), moment()],
                '<?php echo e(__("30 ngày qua")); ?>': [moment().subtract(29, 'days'), moment()],
                '<?php echo e(__("Tháng này")); ?>': [moment().startOf('month'), moment().endOf('month')],
                '<?php echo e(__("Tháng qua")); ?>': [moment().subtract(1, 'month').startOf('month'), moment().subtract(1, 'month').endOf('month')],
                '<?php echo e(__("Năm này")); ?>': [moment().startOf('year'), moment().endOf('year')],
                '<?php echo e(__('Tuần này')); ?>': [moment().startOf('week'), end]
            }
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\Booking Core 1.1.0\booking-core\modules/Dashboard/Views/index.blade.php ENDPATH**/ ?>