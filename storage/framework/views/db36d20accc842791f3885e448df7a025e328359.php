...
<div class="header-logo flex-shrink-0">
    <h3 class="logo-text"><a href="<?php echo e(url('/admin')); ?>">App đặt phòng <span><?php echo e(config('app.version')); ?></span></a></h3>
</div>
<div class="header-widgets d-flex flex-grow-1">
    <div class="widgets-left d-flex flex-grow-1 align-items-center">
        ...
        <div class="header-widget search-widget">
            ...
            <a href="<?php echo e(url('/')); ?>" class="btn btn-link" target="_blank"><i class="fa fa-eye"></i> <?php echo e(__('Trang chủ')); ?>
    ...
    <div class="widgets-right flex-shrink-0 d-flex">
        <div class="dropdown header-widget widget-user">
            ...
            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                <a class="dropdown-item" href="<?php echo e(url('admin/module/user/edit/'.$user->id)); ?>"><?php echo e(__('Chỉnh sửa hồ sơ')); ?></a>
                <a class="dropdown-item" href="<?php echo e(url('admin/module/user/password/'.$user->id)); ?>"><?php echo e(__('Thay đổi mật khẩu')); ?></a>
                <a class="dropdown-item" href="#" onclick="event.preventDefault(); document.getElementById('logout-form').submit();"><i class="fa fa-sign-out"></i> <?php echo e(__('Đăng xuất')); ?>
...
<?php /**PATH C:\laragon\www\Booking Core 1.1.0\booking-core\resources\views/admin/layouts/parts/header.blade.php ENDPATH**/ ?>