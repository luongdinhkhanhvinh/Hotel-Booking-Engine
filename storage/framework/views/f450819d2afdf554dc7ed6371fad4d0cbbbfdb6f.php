    ...
    <form action="<?php echo e(url('admin/module/user/role/save_permissions')); ?>" method="post">
        ...
        <div class="container">
            <div class="d-flex justify-content-between mb20">
                <div class="">
                    <h1 class="title-bar"><?php echo e(__('Ma trận cho phép')); ?></h1>
                </div>
            </div>
                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table class="table table-hover">
                                    <thead>
                                    <tr>
                                        <td><strong><?php echo e(__('Vai trò')); ?></strong></td>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\Booking Core 1.1.0\booking-core\modules/User/Views/admin/role/permission_matrix.blade.php ENDPATH**/ ?>