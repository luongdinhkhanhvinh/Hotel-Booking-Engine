                        ...
                        <div class="col-xs-12  col-md-7 col-lg-6">
                            <div class="media ">
                                ...
                                <div class="media-body">
                                    <h4 class="media-heading"><?php echo e(__("Nhận cập nhật & hơn thế nữa")); ?></h4>
                                    <p><?php echo e(__("Suy nghĩ chu đáo đến hộp thư của bạn")); ?></p>
                                </div>
                            </div>
                        </div>
                        <div class="col-xs-12 col-md-5 col-lg-6">
                            <form action="<?php echo e(route('newsletter.subscribe')); ?>" class="subcribe-form bravo-subscribe-form bravo-form">
                                ...
                                <div class="form-group">
                                    <input type="text" name="email" class="form-control email-input" placeholder="<?php echo e(__('Email Của Bạn')); ?>">
                                    <button type="submit" class="btn-submit"><?php echo e(__('Theo dõi')); ?>
...
<?php \App\Helpers\ReCaptchaEngine::scripts() ?><?php /**PATH C:\laragon\www\Booking Core 1.1.0\booking-core\resources\views/layouts/parts/footer.blade.php ENDPATH**/ ?>