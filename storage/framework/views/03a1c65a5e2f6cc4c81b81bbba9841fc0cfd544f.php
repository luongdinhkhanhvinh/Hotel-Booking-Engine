<?php if(!empty($seo_meta)): ?>
    ...
    <?php endif; ?>
    <title><?php echo e($seo_meta['seo_title'] ?? $seo_meta['service_title'] ?? $page_title ?? ""); ?> - <?php echo e(setting_item('site_title' ,'App đặt phòng')); ?></title>
...
<?php else: ?>
    <title><?php echo e($page_title ?? ''); ?> <?php echo e(setting_item('site_title' ,'App đặt phòng')); ?></title>
    <meta name="description" content="<?php echo e(setting_item("site_desc")); ?>"/>
<?php endif; ?>
<?php /**PATH C:\laragon\www\Booking Core 1.1.0\booking-core\resources\views/layouts/parts/seo-meta.blade.php ENDPATH**/ ?>