<div class="bravo_filter">
    <form action="" class="bravo_form_filter">
        ...
        <div class="filter-title">
            <?php echo e(__("LỌC THEO")); ?>

        </div>
        <div class="g-filter-item">
            <div class="item-title">
                <h4><?php echo e(__("Lọc theo giá")); ?></h4>
            ...
            <div class="item-content">
                <div class="bravo-filter-price">
                    ...
                    <button type="submit" class="btn btn-link btn-apply-price-range"><?php echo e(__("CHẤP NHẬN")); ?></button>
                </div>
            </div>
        </div>
        <div class="g-filter-item">
            <div class="item-title">
                <h4><?php echo e(__("Loại chuyến")); ?></h4>
                <i class="fa fa-angle-up" aria-hidden="true"></i>
            </div>
            <div class="item-content">
                <ul>
                ...
                <button type="button" class="btn btn-link btn-more-item"><?php echo e(__("Nhiều hơn")); ?> <i class="fa fa-caret-down"></i>
                </button>
            </div>
        </div>
        <div class="g-filter-item">
            <div class="item-title">
                <h4><?php echo e(__("Thời gian lưu trú")); ?></h4>
                <i class="fa fa-angle-up" aria-hidden="true"></i>
            </div>
            <div class="item-content">
                <ul>
                        ...
                        <div class="bravo-checkbox">
                            <label>
                                <input name="duration[]" <?php if (is_array(Request::query('duration')) and in_array("0;3", Request::query('duration')))
                                    echo "checked"; ?> type="checkbox" value="0;3"> <?php echo e(__("0 – 3 giờ")); ?>
                        ...
                        <div class="bravo-checkbox">
                            <label>
                                <input name="duration[]" <?php if (is_array(Request::query('duration')) and in_array("3;5", Request::query('duration')))
                                    echo "checked"; ?>  type="checkbox" value="3;5"> <?php echo e(__("3 – 5 giờ")); ?>
                        ...
                        <div class="bravo-checkbox">
                            <label>
                                <input name="duration[]" <?php if (is_array(Request::query('duration')) and in_array("5;7", Request::query('duration')))
                                    echo "checked"; ?>  type="checkbox" value="5;7"> <?php echo e(__("5 – 7 giờ")); ?>
                        ...
                        <div class="bravo-checkbox">
                            <label>
                                <input name="duration[]" <?php if (is_array(Request::query('duration')) and in_array("7;9", Request::query('duration')))
                                    echo "checked"; ?>  type="checkbox" value="7;9"> <?php echo e(__("7 – 9 giờ")); ?>
...
</div><?php /**PATH C:\laragon\www\Booking Core 1.1.0\booking-core\modules/Tour/Views/frontend/layouts/search/filter-search.blade.php ENDPATH**/ ?>