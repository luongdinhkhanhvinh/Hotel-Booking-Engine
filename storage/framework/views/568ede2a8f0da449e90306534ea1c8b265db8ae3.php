    ...
    <div class="row">
        <div class="col-md-5 border-right">
            <div class="form-group field-detination">
                ...
                <div class="dropdown" id="dropdown-destination">
                    <label><?php echo e(__("Nơi đến")); ?></label>
                    <select name="location_id" class="form-control">
                        <option value=""><?php echo e(__("Bạn đi đến đâu?")); ?></option>
                        <?php
            ...
            <div class="form-group form-date-field form-date-search clearfix  has-icon" data-format="DD/MM/YYYY">
                ...
                <div class="date-wrapper clearfix">
                    <div class="check-in-wrapper">
                        <label><?php echo e(__("Từ - Đến")); ?></label>
        ...
        <div class="col-md-2">
            <div class="g-button-submit">
                <button class="btn btn-primary btn-search" type="submit"><?php echo e(__("Tìm kiếm")); ?></button>
            </div>
        </div>
    </div>
</form><?php /**PATH C:\laragon\www\Booking Core 1.1.0\booking-core\modules/Tour/Views/frontend/blocks/form-search-tour/form-search.blade.php ENDPATH**/ ?>