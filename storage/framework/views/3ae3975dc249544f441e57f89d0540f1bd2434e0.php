...
<head>
    ...
    <title><?php echo e($page_title ?? 'Bảng điều khiển'); ?> - <?php echo e(setting_item('site_title') ?? 'Ứng dụng đặt phòng'); ?></title>
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-6 copy-right" >
                        <?php echo e(date('Y')); ?> &copy; Ứng dụng đặt phòng bới <a href="#" target="_blank">Nhóm phát triển</a>
                    </div>
                    <div class="col-md-6">
                        <div class="text-md-right footer-links d-none d-sm-block">
                            <a href="https://www.bookingcore.org" target="_blank">Về chúng tôi</a>
                            <a href="https://m.me/bookingcore" target="_blank">Liên hệ với chúng tôi</a>
                        </div>
                    </div>
                </div>
            </div>
...
<?php /**PATH C:\laragon\www\Booking Core 1.1.0\booking-core\resources\views/admin/layouts/app.blade.php ENDPATH**/ ?>