                        ...
                        <?php else: ?>
                            <li class="login-item dropdown">
                                ...
                                <a href="#" data-toggle="dropdown" class="is_login">
                                    ...
                                    <?php endif; ?>
                                    <?php echo e(__("Chào, :Name",['name'=>Auth::user()->name])); ?>
                                ...
                                <ul class="dropdown-menu text-left">
                                    ...
                                    <?php endif; ?>
                                    <li class="menu-hr">
                                        <a  href="#" onclick="event.preventDefault(); document.getElementById('logout-form').submit();"><i class="fa fa-sign-out"></i> <?php echo e(__('Đăng xuất')); ?></a>
                                    </li>
                                </ul>
...
</div><?php /**PATH C:\laragon\www\Booking Core 1.1.0\booking-core\resources\views/layouts/parts/header.blade.php ENDPATH**/ ?>