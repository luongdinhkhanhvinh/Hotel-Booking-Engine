        ...
        <div class="col-md-5 border-right">
            <div class="form-group field-detination">
                ...
                <div class="dropdown" id="dropdown-destination">
                    <label><?php echo e(__("Nơi đền")); ?></label>
                    <select name="location_id" class="form-control">
                        <option value=""><?php echo e(__("Bạn đi đâu?")); ?></option>
                        <?php
...
</form><?php /**PATH C:\laragon\www\Booking Core 1.1.0\booking-core\modules/Tour/Views/frontend/layouts/search/form-search.blade.php ENDPATH**/ ?>