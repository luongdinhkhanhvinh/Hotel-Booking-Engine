        ...
        <div class="container-fluid">
            <div class="d-flex justify-content-between mb20">
                <div class="">
                    ...
                    @if($row->slug)
                        <p class="item-url-demo">{{__("Liên kết vĩnh cữu")}}: {{ route('location.detail',['slug' => false]) }}/<a href="#" class="open-edit-input" data-name="slug">{{$row->slug}}</a></p>
                    @endif
                </div>
                <div class="">
                    @if($row->slug)
            ...
            <div class="row">
                <div class="col-md-9">
                    <div class="panel">
                        <div class="panel-body">
                            <h3 class="panel-body-title">{{__("Nội dung địa điểm")}}</h3>
                ...
                <div class="col-md-3">
                    ...
                    <div class="panel">
                        <div class="panel-title"><strong>{{__('Ảnh nổi bật')}}</strong></div>
                        <div class="panel-body">
