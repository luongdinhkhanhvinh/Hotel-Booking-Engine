        ...
        <div id="bravo_tour_book_app" v-cloak>
            ...
            <div class="form-content">
                    ...
                    <div class="form-group form-guest-search" v-for="(type,index) in person_types">
                        <div class="guest-wrapper d-flex justify-content-between align-items-center">
                            <div class="flex-grow-1">
                                ...
                                <div class="render check-in-render">@{{type.display_price}} {{__("trên người")}}</div>
                            </div>
                ...
                <div class="form-section-group" v-if="extra_price.length">
                    <h4 class="form-section-title">{{__('Giá thêm:')}}</h4>
            ...
            <div class="submit-group">
                <a class="btn btn-large" @click="doSubmit($event)" :class="{'disabled':onSubmit,'btn-success':(step == 2),'btn-primary':step == 1}" name="submit">
                    <span v-if="step == 1">{{__("ĐẶT NGAY")}}</span>
                    <span v-if="step == 2">{{__("Đặt Ngay")}}</span>
