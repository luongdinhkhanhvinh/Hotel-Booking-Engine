@if(setting_item("tour_enable_review"))
    <div class="bravo-reviews">
        <h2 class="title-review">{{__("Đánh giá")}}</h2>
                    ...
                    <div class="col-lg-5">
                        <div class="review-box-score">
                            ...
                            <div class="review-score-base">
                                {{__("Dựa trên")}} <span>{{$review_score['total_review']}} {{__("đánh giá")}}</span>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-7">
        ...
        <div class="review-pag-wrapper">
            @if($review_list->total() > 0)
                ...
                <div class="review-pag-text">
                    {{ __("Hiển thị :from - :to của :total total",["from"=>$review_list->firstItem(),"to"=>$review_list->lastItem(),"total"=>$review_list->total()]) }}
                </div>
            @else
                <div class="review-pag-text">{{__("Không có Đánh giá")}}</div>
            @endif
        </div>
            ...
            <div class="form-wrapper">
                ...
                <form action="{{ url("/review") }}" class="needs-validation" novalidate method="post">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <div class="invalid-feedback">{{__('Tiêu đề đánh giá là bắt buộc')}}</div>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-xs-12 col-md-8">
                            <div class="form-group">
                                ...
                                <div class="invalid-feedback">
                                    {{__('Nội dung đánh giá phải có ít nhất 10 ký tự')}}
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="text-center">
                        ...
                        <input id="submit" type="submit" name="submit" class="btn" value="{{__("Đề lại một Đánh giá")}}">
                    </div>
                </form>
            </div>
        </div>
