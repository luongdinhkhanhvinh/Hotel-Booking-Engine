    ...
    <div class="right">
        @if($review_score = $row->review_data)
            <div class="review-score">
                ...
                <span>
                    {{__("từ :number đanh giá",['number'=>$review_score['total_review']])}}
                </span>
            </div>
        @endif
    </div>
            ...
            <div class="col-xs-6 col-lg-3 col-md-6">
                <div class="item">
                    ...
                    <div class="info">
                        ...
                        <p class="value">
                            @if($row->duration > 1)
                                {{ __(":number giờ",array('number'=>$row->duration)) }}
                            @else
                                {{ __(":number giờ",array('number'=>$row->duration)) }}
                            @endif
                        </p>
        ...
        @if(!empty($row->category_tour->name))
            <div class="col-xs-6 col-lg-3 col-md-6">
                <div class="item">
                    ...
                    <div class="info">
                        <h4 class="name">{{__("Loại chuyến")}}</h4>
                        <p class="value">
        ...
        @if($row->max_people)
            <div class="col-xs-6 col-lg-3 col-md-6">
                <div class="item">
                    ...
                    <div class="info">
                        <h4 class="name">{{__("Kích cở nhóm")}}</h4>
                        <p class="value">
                            {{$row->max_people}} {{__("người")}}
                        </p>
                    </div>
                </div>
            </div>
