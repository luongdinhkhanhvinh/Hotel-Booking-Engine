        ...
        <div class="g-filter-item">
            ...
            <div class="item-content">
                <div class="bravo-filter-price">
                    ...
                    <button type="submit" class="btn btn-link btn-apply-price-range">{{__("CHẤP NHẬN")}}</button>
                </div>
            </div>
        </div>
        <div class="g-filter-item">
            <div class="item-title">
                <h4>{{__("Loại chuyến")}}</h4>
                <i class="fa fa-angle-up" aria-hidden="true"></i>
            </div>
            <div class="item-content">
                <ul>
                ...
                <button type="button" class="btn btn-link btn-more-item">{{__("Nhiều hơn")}} <i class="fa fa-caret-down"></i>
                </button>
            </div>
        </div>
        <div class="g-filter-item">
            <div class="item-title">
                <h4>{{__("Thời gian lưu trú")}}</h4>
                <i class="fa fa-angle-up" aria-hidden="true"></i>
            </div>
            <div class="item-content">
                <ul>
                        ...
                        <div class="bravo-checkbox">
                            <label>
                                <input name="duration[]" <?php if (is_array(Request::query('duration')) and in_array("0;3", Request::query('duration')))
                                    echo "checked"; ?> type="checkbox" value="0;3"> {{__("0 – 3 giờ")}}
                                <span class="checkmark"></span>
                            </label>
                        </div>
                    </li>
                        ...
                        <div class="bravo-checkbox">
                            <label>
                                <input name="duration[]" <?php if (is_array(Request::query('duration')) and in_array("3;5", Request::query('duration')))
                                    echo "checked"; ?>  type="checkbox" value="3;5"> {{__("3 – 5 giờ")}}
                                <span class="checkmark"></span>
                            </label>
                        </div>
                    </li>
                        ...
                        <div class="bravo-checkbox">
                            <label>
                                <input name="duration[]" <?php if (is_array(Request::query('duration')) and in_array("5;7", Request::query('duration')))
                                    echo "checked"; ?>  type="checkbox" value="5;7"> {{__("5 – 7 giờ")}}
                                <span class="checkmark"></span>
                            </label>
                        </div>
                    </li>
                        ...
                        <div class="bravo-checkbox">
                            <label>
                                <input name="duration[]" <?php if (is_array(Request::query('duration')) and in_array("7;9", Request::query('duration')))
                                    echo "checked"; ?>  type="checkbox" value="7;9"> {{__("7 – 9 giờ")}}
                                <span class="checkmark"></span>
                            </label>
                        </div>
                    </li>
