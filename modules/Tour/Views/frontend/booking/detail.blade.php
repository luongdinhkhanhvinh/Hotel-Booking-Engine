<div class="booking-review">
    <h4 class="booking-review-title">{{__("Phòng Của Bạn Đặt")}}</h4>
    <div class="booking-review-content">
        ...
        <div class="review-section">
            <ul class="review-list">
                @if($booking->start_date)
                    <li>
                        <div class="label">{{__('Ngày bắt đầu:')}}</div>
                        <div class="val">
                            {{display_date($booking->start_date)}}
                        </div>
                    </li>
                    <li>
                        <div class="label">{{__('Thời gian lưu trú:')}}</div>
                        <div class="val">
        ...
        <div class="review-section total-review">
            <ul class="review-list">
                ...
                @else
                    <li>
                        <div class="label">{{__("Khách")}}: {{$booking->total_guests}} * {{format_money($booking->getMeta('base_price'))}}</div>
                        <div class="val">
                ...
                @if(!empty($extra_price))
                    <li>
                        <div class="label-title"><strong>{{__("Giá thêm:")}}</strong></div>
                    </li>
                    <li class="no-flex">
                        <ul>
                ...
                @if(!empty($discount_by_people))
                    <li>
                        <div class="label-title"><strong>{{__("Giảm giá:")}}</strong></div>
                    </li>
                    <li class="no-flex">
                        <ul>
                ...
                <li class="final-total">
                    <div class="label">{{__("Tổng cộng:")}}</div>
