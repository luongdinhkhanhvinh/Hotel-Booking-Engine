    ...
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-header">
                <h4 class="modal-title">{{__("ID đặt")}}: #{{$booking->id}}</h4>
            </div>
            <!-- Modal body -->
            <div class="modal-body">
                <ul class="nav nav-tabs">
                    <li class="nav-item">
                        <a class="nav-link active" data-toggle="tab" href="#booking-detail-{{$booking->id}}">{{__("Chi tiết đặt")}}</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" data-toggle="tab" href="#booking-customer-{{$booking->id}}">{{__("Thông tin của bạn")}}</a>
                    </li>
                </ul>
                            ...
                            <div class="booking-review-content">
                                <div class="review-section">
                                    <div class="info-form">
                                        <ul>
                                            <li>
                                                <div class="label">{{__('Ngày đặt')}}</div>
                                            ...
                                            @if(!empty($booking->gateway))
                                                ...
                                                <li>
                                                    <div class="label">{{__('Hình thức thanh toán')}}</div>
            ...
            <div class="modal-footer">
                <span class="btn btn-secondary" data-dismiss="modal">{{__("Thoát")}}</span>
            </div>
        </div>
    </div>
</div>
