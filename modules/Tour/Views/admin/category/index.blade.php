...
@section('content')
    <div class="container-fluid">
        <div class="d-flex justify-content-between mb20">
            <h1 class="title-bar">{{__("Danh mục chuyến đi")}}</h1>
        </div>
        @include('admin.message')
        <div class="row">
            <div class="col-md-4 mb40">
                <div class="panel">
                    <div class="panel-title">{{__("Thêm danh mục")}}</div>
                    ...
                    <div class="col-left">
                        @if(!empty($rows))
                            <form method="post" action="{{url('admin/module/tour/category/editBulk')}}" class="filter-form filter-form-left d-flex justify-content-start">
                                ...
                                <button data-confirm="{{__("Do you want to delete?")}}" class="btn-info btn btn-icon dungdt-apply-form-btn" type="submit">{{__('Chấp nhận')}}</button>
                            </form>
                        @endif
                    </div>
                    <div class="col-left">
                        ...
                        <form class="bravo-form-item">
                            <table class="table table-hover">
                                ...
                                <tr>
                                    ...
                                    <th>{{__("Tên")}}</th>
                                    <th class="slug d-none d-md-block">{{__("Nguồn gốc")}}</th>
