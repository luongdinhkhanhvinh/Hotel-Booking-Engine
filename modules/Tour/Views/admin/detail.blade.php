    ...
    <form action="" method="post">
        ...
        <div class="container-fluid">
            <div class="d-flex justify-content-between mb20">
                <div class="">
                    <h1 class="title-bar">{{$row->id ? __('Sửa: ').$row->title : __('Thêm chuyến đi mới')}}</h1>
                    @if($row->slug)
                        <p class="item-url-demo">{{__("Liên kết vĩnh viễn")}}: {{ url(config('tour.tour_route_prefix') ) }}/<a href="#" class="open-edit-input" data-name="slug">{{$row->slug}}</a>
                        </p>
                    @endif
                </div>
                <div class="">
                    @if($row->slug)
                        <a class="btn btn-primary btn-sm" href="{{$row->getDetailUrl()}}" target="_blank">{{__("Xem chuyến đi")}}</a>
                    @endif
                </div>
            </div>
            <div class="row">
                ...
                <div class="col-md-3">
                    ...
                    <div class="panel">
                        <div class="panel-title"><strong>{{__("Chuyến đi nổi bật")}}</strong></div>
                        <div class="panel-body">
                    ...
                    <div class="panel">
                        <div class="panel-title"><strong>{{__('Hình ảnh nổi bật')}}</strong></div>
                        <div class="panel-body">
                            <div class="form-group">
