<div class="panel">
    <div class="panel-title"><strong>{{__("Khả dụng")}}</strong></div>
    <div class="panel-body">
        <h3 class="panel-body-title">{{__('Giờ mở cửa')}}</h3>
        <div class="form-group">
            <label>
                <input type="checkbox" name="enable_open_hours" @if(!empty($row->meta->enable_open_hours)) checked @endif value="1"> {{__('Kích hoạt giờ mở cửa')}}
            </label>
        </div>
