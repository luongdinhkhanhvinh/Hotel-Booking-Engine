...
@section ('content')
    ...
    <div class="container-fluid">
        <div class="d-flex justify-content-between mb20">
            <h1 class="title-bar">{{__("Lịch đặt chuyến đi")}}</h1>
        </div>
        @include('admin.message')
        <div class="panel">
{{--            <div class="panel-title"><strong>{{__("Lọc chuyến đi")}}</strong></div>--}}
                    ...
                    <div class="col-left">
                        <form method="get" action="" class="filter-form filter-form-left d-flex flex-column flex-sm-row" role="search">
                            ...
                            <select name="cat_id" class="form-control">
                                <option value="">{{ __('--Toàn bộ danh mục --')}} </option>
                                <?php
        ...
        <div class="booking-calendar vec-wrap panel" id="booking-calendar" >
            <div class="panel-body">
                ...
                <table class="vec-view-container" width="100%" cellpadding="0" cellspacing="0">
                    ...
                    <tr>
                        <th width="300px" class="vec-event-header">{{__('Chuyến đi')}}</th>
