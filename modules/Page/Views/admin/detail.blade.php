    ...
    <form action="" method="post">
        ...
        <div class="container-fluid">
            <div class="d-flex justify-content-between mb20">
                <div class="">
                    <h1 class="title-bar">{{$row->id ? __('Edit: ') .$row->title :  __('Thêm trang mới') }}</h1>
                    @if($row->slug)
                ...
                <div class="">
                    @if($row->slug)
                        <a class="btn btn-primary btn-sm" href="{{$row->getDetailUrl()}}" target="_blank">{{ __('Xem trang')}}</a>
                    @endif
                </div>
            </div>
            <div class="row">
                <div class="col-md-9">
                    <div class="panel">
                        <div class="panel-body">
                            <h3 class="panel-body-title">{{ __('Nội dung trang')}}</h3>
                ...
                <div class="col-md-3">
                    ...
                    <div class="panel">
                        <div class="panel-title"><strong>{{__('Cài đặt mẫu')}}</strong></div>
                        <div class="panel-body">
                    ...
                    <div class="panel">
                        <div class="panel-body">
                            <h3 class="panel-body-title">{{ __('Hình ảnh nổi bật')}}</h3>
                            <div class="form-group">
