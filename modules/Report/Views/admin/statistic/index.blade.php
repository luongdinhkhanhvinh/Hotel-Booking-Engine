...
@section ('content')
    <div class="container-fluid">
        <div class="d-flex justify-content-between mb20">
            <h1 class="title-bar">{{__('Thống kê đặt chổ')}}</h1>
        </div>
                ...
                <div class="col-md-12">
                    <form action="" class="form-fiter-statistic">
                        <div class="header-statistic">
                            ...
                            <div class="item no-padding">
                                <div class="group-icon">
                                    <select name="user_type">
                                        <option value="">{{__("--  Loại người dùng --")}}</option>
                                        <option value="customer">{{__("Người dùng là khách hàng")}}</option>
                                        <option value="vendor">{{__("Người dùng là nhà cung cấp")}}</option>
                                    </select>
                            ...
                            <div class="item">
                                <button type="submit" class="btn-submit">{{__("Chấp nhận")}}
        ...
        jQuery(function ($) {
                ...
                options: {
                    ...
                    scales: {
                        ...
                        yAxes: [{
                            ...
                            scaleLabel: {
                                display: true,
                                labelString: '{{__("Tiền tệ: :currency_main",['currency_main'=>setting_item('currency_main')])}}'
                            }
                        }]
                    },
                    tooltips: {
            ...
            $('#reportrange').daterangepicker({
                ...
                ranges: {
                    ...
                    '{{__("Tháng trước")}}': [moment().subtract(1, 'month').startOf('month'), moment().subtract(1, 'month').endOf('month')],
                    '{{__("Năm nay")}}': [moment().startOf('year'), moment().endOf('year')],
