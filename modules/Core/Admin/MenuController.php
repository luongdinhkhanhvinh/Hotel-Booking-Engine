...
class MenuController extends AdminController
{
    ...
    public function getItems(Request $request)
    {
        ...
        if (empty($menu))
            $this->sendError(__("Bảng chọn không tìm thấy"));
    ...
    public function store(Request $request)
    {
        ...
        ], __('Bảng chọn của bạn đã được lưu'));
    }
}