<div class="row">
    <div class="col-sm-4">
        <h3 class="form-group-title">{{__("Phong cách chung")}}</h3>
        <p class="form-group-desc">{{__('Thay đổi màu chính, kiểu chữ ...')}}</p>
    </div>
    <div class="col-sm-8">
        <div class="panel">
...
<div class="row">
    <div class="col-sm-4">
        <h3 class="form-group-title">{{__("Tùy chỉnh CSS")}}</h3>
        <p class="form-group-desc">{{__('Viết mã css tùy chỉnh của riêng bạn')}}</p>
    </div>
    <div class="col-sm-8">
        <div class="panel">
            <div class="panel-title"><strong>{{__('Tùy chỉnh CSS')}}</strong></div>
            <div class="panel-body">
                <div class="form-group">
                    <label>{{__("Tùy chỉnh CSS")}}</label>
                    <div class="form-controls">
