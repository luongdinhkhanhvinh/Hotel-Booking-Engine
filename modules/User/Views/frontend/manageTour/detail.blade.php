                ...
                <div class="col-md-9">
                    <div class="user-form-settings">
                        ...
                        <h2 class="title-bar no-border-bottom">
                            {{$row->id ? 'Sửa: '.$row->title : 'Thêm mới chuyến đi'}}
                        </h2>
                        ...
                        <form action="" method="post">
                            ...
                            <div class="form-add-service">
                                <div class="nav nav-tabs nav-fill" id="nav-tab" role="tablist">
                                    <a data-toggle="tab" href="#nav-tour-content" aria-selected="true" class="active">{{__("1. Nội dung chuyến đi")}}</a>
                                    <a data-toggle="tab" href="#nav-tour-location" aria-selected="false">{{__("2. Địa điểm của chuyến đi")}}</a>
                                    <a data-toggle="tab" href="#nav-tour-pricing" aria-selected="false">{{__("3. Giá của chuyến đi")}}</a>
                                    <a data-toggle="tab" href="#nav-availability" aria-selected="false">{{__("4. Chuyến đi sẵn có")}}</a>
                                    {{--<a data-toggle="tab" href="#nav-seo" aria-selected="false">{{__("5. SEO chuyến đi")}}</a>--}}
                                </div>
                                <div class="tab-content" id="nav-tabContent">
                                    <div class="tab-pane fade show active" id="nav-tour-content">
                                        @include('Tour::admin/tour/tour-content')
                                        <div class="form-group">
                                            <label>{{__("Hình ảnh đặc trưng")}}</label>
