...
<div class="sidebar-user">
    ...
    <div class="user-profile-avatar">
        <div class="info-new">
            ...
            <p>{{ __("Thành viên từ :time" , ['time'=> date("M Y",strtotime($dataUser->created_at))]) }}</p>
        </div>
    </div>
    ...
    <div class="logout">
        ...
        <a href="#" onclick="event.preventDefault(); document.getElementById('logout-form').submit();"><i class="fa fa-sign-out"></i> {{__("Đăng xuất")}}
        </a>
    </div>
    <div class="logout">
        <a href="{{url('/')}}"><i class="fa fa-long-arrow-left"></i> {{__("Trở về trang chủ")}}</a>
    </div>
</div>
