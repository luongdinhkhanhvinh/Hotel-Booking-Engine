    ...
    public function create(Request $request)
    {
        if (!empty($request->input())) {
            ...
            if ($row->save()) {
                ...
                return redirect('admin/module/user/permission')->with('success', __('Quyền được tạo'));
            }
        } else {
            $row = new Permission();
            $row->fill([
    ...
    public function edit(Request $request, $id)
    {
        ...
        if (!empty($request->input())) {
            ...
            if ($row->save()) {
                ...
                return redirect('admin/module/user/permission')->with('success', __('Cập nhật quyền'));
            }
        }
        $data = [
            'row' => $row
