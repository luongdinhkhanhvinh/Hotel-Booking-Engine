...
class RoleController extends AdminController
{
    ...
    public function create(Request $request)
    {
        if (!empty($request->input())) {
            ...
            if ($row->save()) {
                return redirect('admin/module/user/role')->with('success', __('Vai trò được tạo'));
            }
        } else {
            $row = new User();
            $row->fill([
    ...
    public function edit(Request $request, $id)
    {
        ...
        if (!empty($request->input())) {
            ...
            if ($row->save()) {
                ...
                return redirect('admin/module/user/role')->with('success', __('Cập nhật vai trò'));
            }
        }
        $data = [
            'row' => $row
    ...
    public function save_permissions(Request $request)
    {
        ...
        return redirect()->back()->with('success', __('Ma trận cấp phép được cập nhật'));
    }
}