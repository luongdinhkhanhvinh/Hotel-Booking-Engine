                        ...
                        @if($rows->count() > 0)
                            <div class="list-news">
                                ...
                                <div class="bravo-pagination">
                                    ...
                                    <span class="count-string">{{ __("Hiển thị :from - :to của :total bài đăng",["from"=>$rows->firstItem(),"to"=>$rows->lastItem(),"total"=>$rows->total()]) }}</span>
                                </div>
                            </div>
                        @else
                            <div class="alert alert-danger">
                                {{__("Xin lỗi, nhưng không có gì phù hợp với cụm từ tìm kiếm của bạn. Vui lòng thử lại với một số từ khóa khác nhau.")}}
                            </div>
                        @endif
                    </div>
                    <div class="col-md-3">
