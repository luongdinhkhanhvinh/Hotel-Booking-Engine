...
@section('content')
    <div class="container-fluid">
        <div class="d-flex justify-content-between mb20">
            <h1 class="title-bar"> {{ __('Danh mục mới')}}</h1>
        </div>
                ...
                <div class="filter-div d-flex justify-content-between ">
                    ...
                    <div class="col-left">
                        <form method="get" action="{{url('/admin/module/news/category/')}} " class="filter-form filter-form-right d-flex justify-content-end" role="search">
                            ...
                            <button class="btn-info btn btn-icon btn_search" id="search-submit" type="submit">{{__('Tìm kiếm danh mục')}}</button>
                        </form>
                    </div>
                </div>
                <div class="panel">
                        ...
                        <form action="" class="bravo-form-item">
                            <table class="table table-hover">
                                ...
                                <tr>
                                    ...
                                    <th> {{ __('Tên')}}</th>
                                    <th> {{ __('Slug')}}</th>
                                    <th class="d-none d-md-block"> {{ __('Ngày')}}</th>
                                </tr>
                                </thead>
                                <tbody>
                                @if(count($rows) > 0)
